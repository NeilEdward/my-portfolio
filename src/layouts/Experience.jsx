...
const roles = [
  {
    ...
    current: true,
    summary:
      "Delivering product features across a large React and TypeScript application and Kotlin and Spring Boot backend services.",
    highlights: [
  ...
  },
  {
    ...
    current: false,
    summary:
      "Developed and maintained a financial platform covering transactions, payments, reporting, and end-to-end accounting workflows.",
    highlights: [
