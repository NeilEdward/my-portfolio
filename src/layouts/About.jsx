    ...
    <Grid templateColumns={{ base: "1fr", lg: "1.25fr 0.75fr" }} gap={6}>
      ...
      >
        <Text color="whiteAlpha.800" fontSize={{ base: "lg", md: "2xl" }} lineHeight="1.7">
          I&apos;m a software engineer who works across product interfaces, backend services,
          data flows, and integrations for complex business workflows.
        </Text>
        <Text mt={6} color="whiteAlpha.600" fontSize={{ base: "md", md: "lg" }} lineHeight="1.8">
          My foundation is in front-end engineering, but my current work also includes Kotlin and
          Spring Boot services, persistence, file-processing pipelines, and event-driven systems.
          I enjoy understanding the complete flow and making each layer more dependable.
        </Text>
